...
impl<'ctx> __sdk::Table for EntityTableHandle<'ctx> {
    ...
    fn iter(&self) -> impl Iterator<Item = Entity> + '_ { self.imp.iter() }
...
pub(super) fn parse_table_update(
    ...
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        ...
        pub trait entityQueryTableAccess {
            #[allow(non_snake_case)]
            /// Get a query builder for the table `Entity`.
            fn entity(&self) -> __sdk::__query_builder::Table<Entity>;
        }

        impl entityQueryTableAccess for __sdk::QueryTableAccessor {
            fn entity(&self) -> __sdk::__query_builder::Table<Entity> {
                __sdk::__query_builder::Table::new("entity")
            }
        }
