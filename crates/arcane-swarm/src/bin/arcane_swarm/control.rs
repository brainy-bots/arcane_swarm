//! Control-mode orchestrator (TCP-driven player ramp for multi-driver harnesses).
//!
//! Extracted from `main.rs` to keep the entry point under 350 lines. Contains
//! the long-running control loop, TCP command server, and connection handler.
...
use crate::backends_spacetimedb::SpacetimeConnectParams;
use crate::runtime::{ArcaneRuntime, BackendRuntime, SpacetimeRuntime};
